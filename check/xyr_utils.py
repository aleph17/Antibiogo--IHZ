...
train_dir = path.join(root_path,"xyr_tf_record/Train")
val_dir = path.join(root_path,"xyr_tf_record/Valid")
test_dir = path.join(root_path,"xyr_tf_record/Test")
orig_train_dir = path.join(root_path,"xyr_tf_record/Original_Train")
corDictDir = '/home/muhammad-ali/working/xyr/frame_corr.json'
